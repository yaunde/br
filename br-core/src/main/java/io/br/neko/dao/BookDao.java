...
import io.br.neko.demain.Page;

import java.util.List;

public interface BookDao {

	public List showRelBooksByBookId(int bookId);

	public Page showBooksBySubId(int subId, int curresnPage, int pageSize);
	...
	public List showBooks(int subId);
	 ...
	 * @return Page
	 */
	public Page doPageByConditons(int superTypeId, int subTypeId, String searchMethod, String upLoadTime,
